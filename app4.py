...
with week1_tab:
    ...
    # Build tables
    ndc_df = pd.DataFrame([
        {"DC": "NDC", "SKU": "Regular",  "Demand": demand["NDC_Regular"],"Produced": prod["NDC_Regular"],
    ...
    sdc_df = pd.DataFrame([
        {"DC": "SDC", "SKU": "Regular",  "Demand": demand["SDC_Regular"],"Produced": prod["SDC_Regular"],
...
with week4_tab:
    ...
    ss = {"NDC_Regular": 5000, "NDC_Diet": 5000, "SDC_Regular": 5000, "SDC_Diet": 5000}
    bts = {"NDC_Regular": 5000, "NDC_Diet": 0, "SDC_Regular": 0, "SDC_Diet": 0}
